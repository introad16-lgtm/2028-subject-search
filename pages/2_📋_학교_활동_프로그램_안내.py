...
MAJOR_DB = {
    ...
    "영어영문학과": {
        "topics": [
            "인공지능 번역기의 발달이 영문학 번역의 질에 미치는 영향 분석", 
            "영미권 문학 작품에 나타난 소수자 인권 문제 비교 연구", 
            "글로벌 비즈니스 환경에서의 효과적인 영문 커뮤니케이션 전략",
            "포스트식민주의 관점에서 본 영연방 문학의 특징과 정체성 탐구",
            "영어 조기 교육이 아동의 모국어 발달에 미치는 영향 고찰",
            "영어 미디어 매체(영화, 드라마)가 대중의 서구 문화 인식에 미치는 영향"
        ],
        "books": ["오만과 편견", "영어의 역사", "위대한 개츠비", "번역의 탄생", "언어본능"], 
        "links": ["한국영어영문학회", "British Council"]
    },
    "심리학과": {
        "topics": [
    ...
    "미디어커뮤니케이션학과": {
        "topics": [
            "딥페이크(Deepfake) 기술 발전이 저널리즘 신뢰도에 미치는 영향", 
            "OTT 플랫폼의 오리지널 콘텐츠 전략이 글로벌 미디어 시장에 미치는 효과", 
            "필터 버블(Filter Bubble) 현상이 민주적 여론 형성에 미치는 위험성 고찰",
            "유튜브 알고리즘이 청소년의 정보 편식 및 정치 성향에 미치는 영향",
            "인터넷 밈(Meme) 문화의 확산이 대중 소통 방식에 미치는 변화",
            "메타버스 환경에서의 새로운 미디어 소비 행태와 광고 전략"
        ],
        "books": ["미디어의 이해", "뉴스의 시대", "호모 미디어쿠스", "생각조종자들", "스마트폰을 떨어뜨렸을 뿐인데"], 
        "links": ["한국언론진흥재단", "방송통신위원회"]
    },
    "반도체공학과": {
        "topics": [
    ...
    "기계공학과": {
        "topics": [
            "자율주행차량의 라이다(LiDAR) 센서 한계 극복을 위한 레이더 융합 기술",
            "친환경 내연기관 및 수소 연료 전지의 열역학적 효율성 비교",
            "생체 모방 로봇(Biomimetic Robotics)의 구동 메커니즘 분석 및 설계",
            "스마트 팩토리 도입에 따른 제조업 공정 최적화 및 불량률 감소 모델",
            "초정밀 가공 기술을 활용한 항공우주 부품의 내구성 향상 연구",
            "미세 유체역학을 적용한 의료용 랩온어칩(Lab-on-a-chip) 유동 해석"
        ],
        "books": ["엔지니어의 서재", "기계공학개론", "파인만의 물리 이야기", "로봇 시대 인간의 일", "미래를 여는 공학"],
        "links": ["한국기계연구원", "대한기계학회"]
    },
    "신소재공학과": {
        "topics": [
    ...
    "약학과": {
        "topics": [
            "항생제 내성균(슈퍼박테리아)의 진화 기전과 표적 치료제 개발 동향", 
            "개인 맞춤형 정밀 의료를 위한 약물 유전체학(Pharmacogenomics)의 적용", 
            "천연물 신약 개발 과정에서의 유효 성분 추출 및 분리 정제 기술",
            "바이오시밀러 개발의 규제 장벽 및 글로벌 경쟁력 확보 방안",
            "나노 입자를 활용한 표적 지향형 약물 전달 시스템(DDS) 연구",
            "마약성 진통제 오남용 문제 해결을 위한 대체 진통 기전 탐구"
        ],
        "books": ["약의 과학", "알고 먹으면 약 모르고 먹으면 독", "플레밍이 들려주는 페니실린 이야기", "세상을 바꾼 10가지 약", "신약개발의 마법사들"], 
        "links": ["식품의약품안전처", "한국약제학회"]
    },
    "초등교육과": {
        "topics": [
            "다문화 가정 아동을 위한 이중언어 교육 및 문화 통합 프로그램 기획", 
            "늘봄학교 전면 도입이 초등 공교육 질에 미치는 영향 분석", 
            "초등학생의 스마트폰 과의존 예방을 위한 자기주도적 미디어 리터러시 교육",
            "에듀테크(Edutech)를 활용한 기초 학력 부진 아동 개별화 지도 방안",
            "초등학생의 또래 관계 형성을 돕는 놀이 중심 인성 교육 모델",
            "과정 중심 평가가 초등학생의 내재적 학습 동기에 미치는 효과"
        ],
        "books": ["에밀", "미래 교육의 조건", "교사도 학교가 두렵다", "아이들의 계급장", "공부 상처"], 
        "links": ["한국교육과정평가원", "에듀넷"]
    }
}
...
<style>
    ...
    /* 🚀 메인 버튼 시원하게 넓히는 CSS 유지 (use_container_width 적용) */
...
# 💡 메인 버튼 너비 100% 꽉 채우기 복구 (use_container_width=True 필수!)
if st.button("🚀 활동 가이드 생성", type="primary", use_container_width=True):
